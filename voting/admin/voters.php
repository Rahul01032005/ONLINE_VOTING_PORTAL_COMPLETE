        ...
        <table class="table">
               ...
               <tbody>
                      ...
                      while($result=mysqli_fetch_assoc($data))
                      {
                        ...
                        <td>".$result['status']."</td>
                        <td><a href='verify_voter.php?vid=$result[id]' style='display:$verify' class='del verify' onClick='return validconfirm()'><i class='fa-solid fa-check'></i> Verify</a>
           ...
           <table class="table">
               ...
               <tbody>
                      ...
                      while($result=mysqli_fetch_assoc($data))
                      {
                        ...
                        <td>".$result['address']."</td>
                        <td>".$result['status']."</td>
                        <td><a href='verify_voter.php?vid=$result[id]' class='del verify' onClick='return validconfirm()' style='display: $verify;'><i class='fa-solid fa-check'></i> Verify</a>
                        <a href='user-update.php?fn=$result[fname]&ln=$result[lname]&idno=$result[idnum]&ph=$result[phone]&ad=$result[address]' class='edit'><i class='fa-solid fa-pen-to-square'></i> Edit</a>
                        <a href='user-delete.php?ph=$result[phone]&file_path=$result[idcard]' class='del' onClick='return delconfirm()'><i class='fa-solid fa-trash-can'></i> Delete</a></td>
                        </tr>";
                      }
