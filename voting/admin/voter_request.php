...
<body>
        ...
        <div class="heading"><h2>Voter Requests</h2></div>
           <table class="table">
               ...
               <tbody>
                      ...
                      {
                        $_SESSION['old_no']=$result['old_phno'];
                        $_SESSION['new_no']=$result['new_phno'];
                        echo "<tr>
                        <td>".$result['vname']."</td>
                        <td>".$result['idname']."</td>
                        ...
                        <td><a href='voter_req_update.php' class='del tempoo'  onClick='return updateconfirm()'><i class='fa-solid fa-pen-to-square'></i> Update</a><br>
                        <a href='voter_req_delete.php?id=$result[id]' class='del' onClick='return delconfirm()'><i class='fa-solid fa-trash-can'></i> Delete</a></td>
                        </tr>";
                      }
    ...
    <script>
        ...
        {
            return confirm('Update this voter');
        }
    </script>
</body>
</html>